...
class Add extends React.Component {
  ...
  insertNewExpense (e) {
    ...
    axios.post('/insert', expense, { headers })
      .then(response => {
  ...
  render () {
    if (this.state.messageFromServer === '') {
      console.log('Add.js render [messageFromServer = ""]:', this.state)
      return (
        <div>
          <Button
      ...
      console.log('Add.js render [messageFromServer is NOT ""]:', this.state)
      return (
        <div>
          <Button
            bsStyle='success' bsSize='small'
